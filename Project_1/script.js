...
const init = ()=>{
  ...
  let to_end = document.getElementById(end_id);
  ...
  begin.addEventListener("click", function() {
    ...
    if (counter <story_array.length){
      var new_paragraph = story_array[counter];

      top_div.innerHTML = top_div.innerHTML + "<div>" + new_paragraph + "</div>";
  ...
  to_end.addEventListener("click", function() {
    top_div.innerHTML = story_array.join('');
  })
